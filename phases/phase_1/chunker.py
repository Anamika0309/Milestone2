"""
Phase 1.4 - Chunker Module (Standalone Phase Copy)
            ...
            for scheme_dir_name in os.listdir(self.output_dir):
                ...
                if os.path.isdir(scheme_dir):
                    ...
                    if os.path.exists(chunks_file):
                        ...
                        if not health_report['last_chunking_time'] or file_mtime > health_report['last_chunking_time']:
                            health_report['last_chunking_time'] = datetime.fromtimestamp(file_mtime, timezone.utc).isoformat()
                    else:
