...
Outputs:
- `data/index/dense_index.faiss`
- `data/index/sparse_index.pkl`
- `indexer.json` (index metadata)

Exit Criteria: All chunks indexed, both index types available
"""
...
class Indexer:
    ...
    def __init__(self, config_dir: str = None):
        ...
        self.input_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'data', 'index')
