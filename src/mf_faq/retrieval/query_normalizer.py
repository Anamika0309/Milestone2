"""
Phase 2.1 - Query Normalizer
Purpose: Normalize user queries for consistent retrieval

Responsibilities:
- NFKC normalization, lowercase, whitespace collapse
- Financial term standardization (₹ symbol, percentage formats)
- MF token expansion (ELSS/SIP/NAV/AUM)

Exit Criteria: Queries normalized consistently, financial terms detected
"""
...
class QueryNormalizer:
    ...
    def __init__(self, config_dir: str = None):
        ...
        logger.info("Initialized query normalizer")
    ...
    def standardize_percentages(self, text: str) -> str:
        ...
        # Normalize various percentage formats
